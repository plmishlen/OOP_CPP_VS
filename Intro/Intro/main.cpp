...
/*	Point()
	...
	*/
	...
	double distance(Point A, Point B)
	{
		...
		double distance = sqrt(dist_a * dist_a + dist_b * dist_b);
		return distance;
	}
...
//создавая структуру или класс мы создаем новый типа данных
//			CLASS-это тип данных
//			STRUCT-это тоже типа данных
//Объекты класса или структуры, являются перменными соотвествующего типа
...
void main()
{
	...
	Point A;	//объявляем переменную 'A' типа Point
				//создаем объект А структуры Point
...
//A.set_x(2);
	...
	Point B(2, 3);
	B.print();
	//cout << "Расстояние между точками: " << distance (Point A, Point B) << endl;
	...
	Point B(7, 8);
	Point C(5, 6);
	cout <<"Расстояние между точками: " << A.distance(B,C)<<endl;
